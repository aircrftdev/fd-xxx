...
async function getConfirmation(context) {
    ...
    return {
        proceed: await context.amplify.confirmPrompt.run('Are you sure you want to continue? (This would delete all the environments of the project from the cloud and wipe out all the local amplify resource files)'),
        deleteS3: true,
    };
}
module.exports = {
