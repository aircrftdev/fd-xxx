...
async function run(context) {
    ...
    let answer;
    do {
        answer = await inquirer_helper_1.default.prompt({
            type: 'list',
            name: 'selection',
...
async function configurePluginDirectories(context, pluginPlatform) {
    ...
    const actionAnswer = await inquirer_helper_1.default.prompt({
        type: 'list',
        name: 'action',
...
async function addPluginDirectory(pluginPlatform) {
    ...
    if (options.length > 0) {
        ...
        const selectionAnswer = await inquirer_helper_1.default.prompt({
            type: 'list',
            name: 'selection',
    ...
    if (addCustomDirectory) {
        const addNewAnswer = await inquirer_helper_1.default.prompt({
            type: 'input',
