...
class ResourceFactory {
    ...
    initTemplate() {
        return {
            ...
            Resources: {
                ...
                [graphql_transformer_common_1.ResourceConstants.RESOURCES.ElasticsearchStreamingLambdaFunctionLogicalID]: this.makeDynamoDBStreamingFunction(),
            },
    ...
    makeSearchResolver(type, nonKeywordFields, primaryKey, queryTypeName, nameOverride) {
            ...
            RequestMappingTemplate: graphql_mapping_template_1.print(graphql_mapping_template_1.compoundExpression([
                ...
                graphql_mapping_template_1.ElasticsearchMappingTemplate.searchItem({
                    ...
                    sort: graphql_mapping_template_1.list([
                        graphql_mapping_template_1.raw('{$sortField0: { "order" : $util.toJson($sortDirection) }}'),
                    ]),
                }),
            ])),
