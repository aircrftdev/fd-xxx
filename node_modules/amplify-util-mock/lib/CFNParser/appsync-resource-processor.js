    ...
    Object.values(resources).forEach(resource => {
        ...
        switch (resourceType) {
            ...
            case 'AWS::AppSync::Resolver':
                appSyncConfig.resolvers.push(Object.assign(Object.assign({}, result), { requestMappingTemplateLocation: result.requestMappingTemplateLocation.replace(RESOLVER_TEMPLATE_LOCATION_PREFIX, ''), responseMappingTemplateLocation: result.responseMappingTemplateLocation.replace(RESOLVER_TEMPLATE_LOCATION_PREFIX, '') }));
                break;
            case 'AWS::DynamoDB::Table':
                appSyncConfig.tables.push(result);
                break;
            case 'AWS::AppSync::FunctionConfiguration':
                appSyncConfig.functions.push(Object.assign(Object.assign({}, result), { requestMappingTemplateLocation: result.requestMappingTemplateLocation.replace(RESOLVER_TEMPLATE_LOCATION_PREFIX, ''), responseMappingTemplateLocation: result.responseMappingTemplateLocation.replace(RESOLVER_TEMPLATE_LOCATION_PREFIX, '') }));
                break;
