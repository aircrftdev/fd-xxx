...
function cfnSub(valNode, { params, conditions, resources, exports }, processValue) {
    ...
    if (!util_1.isString(strTemplate)) {
...
function cfnGetAtt(valNode, { params, conditions, resources, exports }, processValue) {
    if (!Array.isArray(valNode) && valNode.length !== 2) {
...
function cfnRef(valNode, { params, conditions, resources, exports }, processValue) {
    let key;
    if (util_1.isString(valNode)) {
        key = valNode;
    }
    else if (util_1.isArray(valNode) && valNode.length === 1) {
...
function cfnSelect(valNode, { params, conditions, resources, exports }, processValue) {
    if (!Array.isArray(valNode) && valNode.length !== 2) {
...
function cfnImportValue(valNode, { params, conditions, resources, exports }, processValue) {
    if (!(lodash_1.isPlainObject(valNode) || util_1.isString(valNode))) {
...
function cfnCondition(valNode, { params, conditions, resources, exports }, processValue) {
    if (!util_1.isString(valNode)) {
