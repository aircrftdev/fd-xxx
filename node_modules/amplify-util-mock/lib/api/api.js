...
class APITest {
    ...
    start(context, port = 20002, wsPort = 20003) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.apiParameters = yield this.loadAPIParameters(context);
                ...
                const appSyncConfig = yield this.runTransformer(context, this.apiParameters);
    ...
    runTransformer(context, parameters = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const { transformerOutput } = yield run_graphql_transformer_1.runTransformer(context);
    ...
    reload(context, filePath, action) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const parameterFilePath = yield this.getAPIParameterFilePath(context);
            try {
                let shouldReload;
                if (this.resolverOverrideManager.isTemplateFile(filePath, action === 'unlink' ? true : false)) {
                    ...
                    const config = yield this.runTransformer(context, this.apiParameters);
    ...
    getAPIParameterFilePath(context) {
        return __awaiter(this, void 0, void 0, function* () {
            const backendPath = yield this.getAPIBackendDirectory(context);
            return path.join(backendPath, 'parameters.json');
        });
    }
    loadAPIParameters(context) {
        return __awaiter(this, void 0, void 0, function* () {
            const paramPath = yield this.getAPIParameterFilePath(context);
